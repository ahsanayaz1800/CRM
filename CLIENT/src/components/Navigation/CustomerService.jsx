...
const CustomerService = () => {
  ...
  return (
    <ul className="sidebar-menu">
      ...
      {/* <li><NavLink className="nav-link" to="/customerSupport"><i className="fas fa-headset"></i> <span>Customer Support</span></NavLink></li>
      <li><NavLink className="nav-link" to="/reports"><i className="fas fa-chart-line"></i> <span>Reports</span></NavLink></li> */}
             <li><NavLink className="nav-link" to="/customer_service_customer"><i className="fas fa-list"></i> <span>Customer Listing</span></NavLink></li>
             <li><NavLink className="nav-link" to="/customer_service_attendance"><i className="fas fa-list"></i> <span>Attendance</span></NavLink></li>
