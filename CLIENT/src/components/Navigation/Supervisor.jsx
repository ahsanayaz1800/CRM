...
const Supervisor = () => {
  ...
  return (
    <ul className="sidebar-menu">
      ...
      <li><NavLink className="nav-link" to="/supervisor_customer"><i className="fas fa-list"></i> <span>Customer Listing</span></NavLink></li>
      <li><NavLink className="nav-link" to="/supervisor_attendance"><i className="fas fa-list"></i> <span>Attendance</span></NavLink></li>

      {/* <li><NavLink className="nav-link" to="/teamOverview"><i className="fas fa-users"></i> <span>Team Overview</span></NavLink></li>
