...
const Adviser = () => {
  ...
  return (
    <ul className="sidebar-menu">
      ...
      <li><NavLink className="nav-link" to="/advisor_customer"><i className="fas fa-list"></i> <span>Customer Listing</span></NavLink></li>
      <li><NavLink className="nav-link" to="/advisor_attendance"><i className="fas fa-list"></i> <span>Attendance</span></NavLink></li>
