...
const Manager = () => {
  ...
  return (
    <ul className="sidebar-menu">
      ...
      <li><NavLink className="nav-link" to="/manager_customer"><i className="fas fa-list"></i> <span>Customer Listing</span></NavLink></li>
    
      <li><NavLink className="nav-link" to="/manager_attendance"><i className="fas fa-list"></i> <span>Attendance</span></NavLink></li>

      {/* <li><NavLink className="nav-link" to="/teamManagement"><i className="fas fa-users-cog"></i> <span>Team Management</span></NavLink></li>
      <li><NavLink className="nav-link" to="/performance"><i className="fas fa-chart-line"></i> <span>Performance</span></NavLink></li>
      <li><NavLink className="nav-link" to="/reports"><i className="fas fa-file-alt"></i> <span>Reports</span></NavLink></li> */}
