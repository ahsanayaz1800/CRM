  ...
  const logout = async () => {
    ...
    return(
      <ul className="sidebar-menu">
        ...
        <li><NavLink className="nav-link" to="/employee_customer"><i className="fas fa-list"></i> <span>Customer Listing</span></NavLink></li>
        ...
        <li><NavLink className="nav-link" to="/userSalary"><i class="fas fa-piggy-bank"></i> <span>Salary</span></NavLink></li> */}
           <li><NavLink className="nav-link" to="/employee_attendance"><i className="fas fa-list"></i> <span>Attendance</span></NavLink></li>
