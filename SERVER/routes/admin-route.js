...
router.get('/all_users', asyncMiddleware(userController.findAllUsers)); // Find All Users
...
router.get('/agents',asyncMiddleware(userController.getUsers));                                  // Employees
router.get('/users',asyncMiddleware(userController.getUsers));                                  // Employees
router.get('/verifiers',asyncMiddleware(userController.getUsers));                                  // Employees
router.get('/advisor',asyncMiddleware(userController.getUsers));                                  // Employees
router.get('/customer_service',asyncMiddleware(userController.getUsers));                                  // Employees
router.get('/junior_admin',asyncMiddleware(userController.getUsers));                                  // Employees
router.get('/supervisors',asyncMiddleware(userController.getUsers));                                  // Employees
router.get('/managers',asyncMiddleware(userController.getUsers));                                  // Employees
